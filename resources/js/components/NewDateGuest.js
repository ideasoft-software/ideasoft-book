...
class NewDateGuest extends Component {
    constructor(props) {
        super(props);
        ...
        this.handleChangeFormOldClient = this.handleChangeFormOldClient.bind(this);
    ...
    validateForm(form) {
        if (form === 1) {
            ...
            if (parseInt(this.state.serviceSelected) === 0 || this.state.serviceSelected === null) {
    ...
    handleChangeFormOldClient(e){
        const form = this.state.formOldClient;
        const form_email= e.target.value;
    ...
    render(){
        return (
            <div className="container-fluid disable-text-selection p-0">
                            ...
                            <div className="tab-content">
                                ...
                                <div className={ this.state.step === 1 ? 'tab-pane fade show active': 'tab-pane fade' } id="first" role="tabpanel" aria-labelledby="select-service">
                                    ...
                                    <form method="#" action="" name="selectServiceForm" id="selectServiceForm" className="justify-content-center text-center">
                                        ...
                                        <div className="form-group text-center col-lg-6 mx-auto">
                                ...
                                <div className={ this.state.step === 3 ? 'tab-pane fade show active': 'tab-pane fade' } id="third" role="tabpanel" aria-labelledby="third-tab">
                                    ...
                                    <div className="justify-content-center">
                                        <p className="text-muted">Por favor selecciona una opción:</p>
                                        < div className="form-group form-inline justify-content-between col-10 mx-auto">
                                            <div className="custom-control custom-radio">
                                                <input type="radio" id="client_option1" name="client_option" checked={this.state.client_option === 1}
                                                       className="custom-control-input" onClick={() => this.setState({client_option: 1})}/>
                                                <label className="custom-control-label" htmlFor="client_option1">Cliente antiguo</label>
                                            </div>
                                            <div className="custom-control custom-radio">
                                                <input type="radio" id="client_option2" name="client_option" checked={this.state.client_option === 2}
                                                       className="custom-control-input" onClick={() => this.setState({client_option: 2})}/>
                                                <label className="custom-control-label" htmlFor="client_option2">Cliente nuevo</label>
                                            </div>
                                        </div>
                                    </div>
                                    }
                                    ...
                                    {this.state.client_option === 1 &&
                                        <div className="container-fluid mt-2 justify-content-center col-lg-10 ">
                                        <form className="needs-validation mb-5" noValidate>

                                            <p>Por favor ingrese tus datos.</p>
                                            <div className="form-row col-12">
                                                ...
                                                */}
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <input type="email" className="form-control" id="email_old" onChange={ (e) => this.handleChangeFormOldClient(e) } value={ this.state.formOldClient.email } placeholder="Correo electrónico" required />
                                                </div>
                                            </div>

                                            { this.state.formOldClient.email && !this.state.formOldClient.exist &&
                                                <div className="alert alert-warning">
                                                    El correo electrónico digitado NO esta registrado.
                                                </div>
                                            }
                                    ...
                                    { this.state.client_option === 2 && !this.state.selectedClient &&
                                        <div className="container-fluid mt-2 justify-content-center col-lg-10 ">
                                            <form className="needs-validation mb-5" noValidate>
...
export default NewDateGuest;
if (document.getElementById('newDateGuestComponent')) {
    ReactDOM.render(<NewDateGuest />, document.getElementById('newDateGuestComponent'));
}
