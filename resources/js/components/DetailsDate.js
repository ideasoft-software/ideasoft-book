...
class DetailsDate extends Component {
    constructor(props) {
        super(props);
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-lg-12 mx-auto text-center">
                                    ...
                                    <h2 className="text-dark mb-0 "><i className="iconsmind-Time-Clock"></i> {this.relativeTime()}</h2>
...
if (document.getElementById('detailsDateComponent')) {
    ReactDOM.render(<DetailsDate/>, document.getElementById('detailsDateComponent'));
}
